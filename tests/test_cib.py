...
def test_payment_form_has_amount():
    html = generate_payment_form("TestShop", "ORD123", "7500")
...
def test_payment_form_has_cib():
    html = generate_payment_form("Test", "ORD1", "1000")
    assert "CIB" in html

def test_payment_form_has_edahabia():
    html = generate_payment_form("Test", "ORD1", "1000")
    assert "Edahabia" in html

def test_payment_form_not_connected():
    html = generate_payment_form("Test", "ORD1", "1000")
    assert "simulate" in html.lower() or "simule" in html.lower()
...
if __name__ == "__main__":
    ...
    test_payment_form_has_cib()
    test_payment_form_has_edahabia()
